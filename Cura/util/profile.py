...
setting('wallOuter_speed',                20, float, 'basic',    _('Speed and Temperature')).setRange(1).setLabel(_("Outer Perimiter speed (mm/s)"), _("Speed at which printing the outer most perimiters"))
setting('wallInner_speed',                50, float, 'basic',    _('Speed and Temperature')).setRange(1).setLabel(_("Inner Perimiter speed (mm/s)"), _("Speed at which printing the inner most perimiters"))
...
validators.warningAbove(settingsDictionary['wallOuter_speed'], 150.0, _("It is highly unlikely that your machine can achieve a printing speed above 150mm/s"))
validators.warningAbove(settingsDictionary['wallInner_speed'], 150.0, _("It is highly unlikely that your machine can achieve a printing speed above 150mm/s"))
validators.printSpeedValidator(settingsDictionary['print_speed'])
validators.printSpeedValidator(settingsDictionary['wallOuter_speed'])
validators.printSpeedValidator(settingsDictionary['wallInner_speed'])
